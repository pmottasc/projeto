...
DROP TRIGGER IF EXISTS trg_chat_notify_participants ON public.chat_messages;
CREATE TRIGGER trg_chat_notify_participants
AFTER INSERT ON public.chat_messages
FOR EACH ROW
EXECUTE FUNCTION public.chat_notify_participants();
